...
If a secret is exposed, treat it as compromised immediately. Revoke/rotate at the provider, invalidate dependent sessions, investigate access logs, and preserve incident evidence.
