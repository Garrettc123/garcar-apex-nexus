# Garcar Autonomous Wiring TODO for garcar-apex-nexus

Role: `unified_control_plane`

_Live fan-out: 2026-09-12 (wet / CASH_LOCK)_

## Required Garcar Base Contract
- [x] `/health` — **added** via `contract/` sidecar
- [x] `/meta` — **added** (role unified_control_plane, contract_version 1.0.0)
...
## Event Bus Wiring
- [ ] Emit required events for this role (`garcar.garcar-apex-nexus.{event_type}`).
